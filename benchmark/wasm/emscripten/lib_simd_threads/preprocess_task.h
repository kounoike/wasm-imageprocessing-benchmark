#ifndef HALIDE______lib_simd_threads___preprocess_task_h
#define HALIDE______lib_simd_threads___preprocess_task_h
#include <stdint.h>
...
int preprocess_task(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int preprocess_task_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *preprocess_task_metadata();
