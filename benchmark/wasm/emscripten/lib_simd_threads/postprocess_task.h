#ifndef HALIDE______lib_simd_threads___postprocess_task_h
#define HALIDE______lib_simd_threads___postprocess_task_h
#include <stdint.h>
...
int postprocess_task(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_background_buffer, struct halide_buffer_t *_inference_buffer, float _threshold, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int postprocess_task_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *postprocess_task_metadata();
