...
# halide generator
pushd /wasm/halide
  g++ -o /tmp/gen preprocess.cpp preprocess_lut.cpp /Halide/share/Halide/tools/GenGen.cpp -I /Halide/include/ -lHalide -L /Halide/lib/ -lm -lpthread -ldl -std=c++17 -Wl,-rpath /Halide/lib
